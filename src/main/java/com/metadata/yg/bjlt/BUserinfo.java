...
/**
 * @author: Y.G
 * @description: B侧用户信息数据
 * @create: 2018-12-27 17:49
 **/
@Data
public class BUserinfo {
    ...
    public BUserinfo(){
        ...
        this.User_State=RandomUtils.getRandomNum(0,3).toString().getBytes(); // TODO: 2018/12/29 用户状态，编码
        ...
        this.User_Addr="".getBytes(); // TODO: 2018/12/29 宽带安装地址
        ...
        this.Device_id=(DataUtils.getMd5(RandomUtils.getRandomNum(10,100000).toString())).getBytes();
        this.Device_type=RandomUtils.getRandomNum(0,4).toString().getBytes();
    }
}
