...
public class ZuserInfo {
    ...
    public ZuserInfo(){
        ...
        this.SubscribeTime=(DateUtils.formatTimeTo24(new Date())+1000*60*60*random+"").getBytes();
        ...
        this.provinceCode="".getBytes();
        this.cityCode="".getBytes();
        this.STB_ID=STB .values()[RandomUtils.getRandomNum(0,2)].toString().getBytes();
    }
}
